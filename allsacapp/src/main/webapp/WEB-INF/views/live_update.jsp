...
<div class="rca-container rca-margin">
	...
	<div class="rca-row">
		...
		<div class="rca-column-6">
			<!--Match Series-->
			<div
				class="rca-medium-widget rca-padding rca-live-season rca-top-border">
				...
				<div class="rca-padding">
					...
					<p class="rca-match-info">
						<span>IND: 16/1 in 1.0</span> <span>CRR:4.1</span> <span>Req
							RR:10.1</span>
					</p>
					<p class="rca-match-info">
						<span>IND: 220/7 in 1.0</span> <span>& 101/4 in 20.0</span>
					</p>
					<div class="rca-top-padding">
						<div class="rca-batsman striker">
							<span class="player">V Kohli</span> <span>48(27)</span>
						</div>
						<div class="rca-batsman">
							<span class="player">MS Dhoni</span> <span>14(8)</span>
						</div>
					</div>
					<div class="rca-ball-detail">
						<div class="rca-match-schedule">Over: 24</div>
				...
				<div class="rca-top-padding rca-score-status">
					<div class="rca-status-scroll">FOUR!!! from Dhoni</div>
			...
			<div class="rca-mini-widget rca-history-info">
				<div class="rca-row">
					<span class="rca-col rca-history-title">Match:</span> <span
						class="rca-col"> Team X vs Team Y - 6th Qualifying Match</span>
				</div>
				<div class="rca-row">
					<span class="rca-col rca-history-title">Series:</span> <span
						class="rca-col"> Developer season 2014</span>
				</div>
				<div class="rca-row">
					<span class="rca-col rca-history-title">Date (GMT):</span> <span
						class="rca-col"> 24th Sep 2014 00:00 GMT</span>
				</div>
				<div class="rca-row">
					<span class="rca-col rca-history-title">Venue:</span> <span
						class="rca-col"> India</span>
				</div>
				<div class="rca-row">
					<span class="rca-col rca-history-title">Match Type:</span> <span
						class="rca-col"> Twenty20 Cricket Match</span>
				</div>
				<div class="rca-row">
					<span class="rca-col rca-history-title">Toss:</span> <span
						class="rca-col"> Team X won the toss and chose to bat first</span>
				</div>
			</div>

			<!--Completed Match Series-->
			<div
				class="rca-medium-widget rca-padding rca-completed-match rca-top-border">
				<div class="rca-right rca-basic-text">12th Feb 2016</div>
				<div class="rca-clear"></div>
				<div class="rca-padding">
					<h3 class="rca-match-title rca-theme-text">India won by 69
						runs</h3>
					<p class="rca-match-info">
					...
					<div class="rca-top-padding">
						<div class="rca-team-score">
							<span class="team">India</span> <span>196/6 in 20.0</span>
						</div>
						<div class="rca-team-score">
							<span class="team">Sri Lanka</span> <span>127/9 in 20.0</span>
						</div>
					</div>
					<div class="rca-man-match">
						<h3>
							Man of the Match <span>S Dawan</span>
						</h3>
						<div class="rca-padding">
							<p class="rca-man-match-record">
								<span class="title">Runs</span><span>51(25)</span>
							</p>
							<p class="rca-man-match-record">
								<span class="title">Boundries</span><span>7X4, 2X6</span>
							</p>
							<p class="rca-man-match-record">
								<span class="title">Wickets</span><span>Nil</span>
							</p>
						</div>
					</div>
				</div>
			...
			<div
				...
				<div class="rca-clear"></div>
				<div class="rca-padding">
					<h3 class="rca-match-title rca-theme-text">BAN VS IND</h3>
					<p class="rca-match-info">
						<span>2nd T20 Match</span>
					</p>
					<div class="rca-top-padding">
					...
					<div class="rca-match-start">
						...
						<div class="rca-padding">
							<h2>1 day</h2>
							<p class="rca-center">Wed 24th Feb 2016, 7:00 pm (local time)
							</p>
						</div>
					</div>
				</div>
		...
		<div class="rca-column-6">
			...
			<div class="rca-medium-widget rca-top-border ">
				<ul class="rca-tab-list">
					...
					<li class="rca-tab-link active" data-tab="tab-41"
						onclick="showTab(this);">${sport.sport_name }</li>
				...
				<div id="tab-41" class="rca-tab-content rca-padding active">
					<div class="rca-batting-score rca-padding">
						...
						<div class="rca-row">
							<div class="rca-table">
								<div class="rca-col rca-player">Player x1*</div>
								<div class="rca-col">8 (7)</div>
								<div class="rca-col">0</div>
								<div class="rca-col">1</div>
								<div class="rca-col">114.29</div>
							</div>
						</div>
						<div class="rca-row">
							<div class="rca-table">
								<div class="rca-col rca-player">Player x2</div>
								<div class="rca-col">8 (7)</div>
								<div class="rca-col">0</div>
								<div class="rca-col">1</div>
								<div class="rca-col">114.29</div>
						...
						<div class="rca-clear"></div>
						<div class="rca-padding">
							<span>Fours: <strong>2</strong></span>, <span>Sixes: <strong>1</strong></span>,
							<span>Extras: <strong>9</strong></span>
						</div>
					</div>
					<div class="rca-bowling-score rca-padding">
						...
						<div class="rca-row">
							<div class="rca-table">
								<div class="rca-col rca-player">Player Y</div>
				...
				<div id="tab-42" class="rca-tab-content rca-padding">
					<ul class="rca-tab-list small">
						<li class="rca-tab-link active" data-tab="tab-411"
							onclick="showTab(this);">Team X</li>
						<li class="rca-tab-link" data-tab="tab-412"
							onclick="showTab(this);">Team Y</li>
					</ul>
                    ...
                    <span class="active">Team X</span><span>Team Y</span>
						...
						<div class="rca-batting-score">
							...
							<div class="rca-player-detail">
								<span class="rca-player">MS Dhoni</span> <span
									class="rca-highlight-text">(C) &amp; (WK)</span> <span
									class="rca-right rca-basic-text">Batsman</span>
							</div>
							<div class="rca-player-detail">
								<span class="rca-player">Shikhar Dhawan</span> <span
									class="rca-right rca-basic-text">Batsman</span>
							</div>
							<div class="rca-player-detail">
								<span class="rca-player">Ajinkya Rahane</span> <span
									class="rca-right rca-basic-text">Bowler</span>
							</div>
							<div class="rca-player-detail">
								<span class="rca-player">Suresh Raina</span> <span
									class="rca-right rca-basic-text">All rounder</span>
							</div>
						</div>
						<div class="rca-batting-score">
							<h3>Bench (9)</h3>
							<div class="rca-player-detail">
								<span class="rca-player">Rohit Sharma</span> <span
									class="rca-highlight-text">(WK)</span> <span
									class="rca-right rca-basic-text">Batsman</span>
							</div>
							<div class="rca-player-detail">
								<span class="rca-player">Rohit Sharma</span> <span
			...
			<div class="rca-medium-widget rca-top-border">
				<ul class="rca-tab-list">
					<li class="rca-tab-link active" data-tab="tab-31"
						onclick="showTab(this);">SCORECARD</li>
				...
				<div id="tab-31" class="rca-tab-content rca-padding active">
					<div class="rca-border-bottom rca-padding">
						<div class="rca-switch rca-top-padding">
							<span class="active">Team X 1st Innings</span><span>Team X
								2nd Innings</span>
						</div>
						<div class="rca-switch rca-top-padding">
					...
					<div class="rca-batting-score rca-padding">
						...
						<div class="rca-row rca-padding">
							<span>Fours: <strong>18</strong></span>, <span>Sixes: <strong>8</strong></span>,
							<span>Extras: <strong>29</strong></span>
						</div>
					</div>
					<div class="rca-bowling-score rca-padding">
						<h3>Team X Bowling:</h3>
...
<script>
	function showTab(event) {
		...
		var sourceChilds = sourceParent
				.getElementsByClassName("rca-tab-content");
		var sourceLinkParent = sourceParent
				.getElementsByClassName("rca-tab-link");
